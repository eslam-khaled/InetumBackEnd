...
using InetumTask.Business.Helpers;
using System.Text;
...
using InetumTask.Business.BusinessImplementation;
using System.Threading.Tasks;
using System;

namespace InetumTask
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
           ...
           options.UseSqlServer(Configuration.GetConnectionString("AppDBContextConnection")));
            ...
            services.AddIdentity<InetumTask.DAL.Models.User, IdentityRole>(options =>
            {
